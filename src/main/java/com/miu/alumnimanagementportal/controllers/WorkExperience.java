...
public class WorkExperience {
    ...
    public ResponseEntity<?> createWorkExperience(@Valid @RequestBody WorkExperienceDto workExperienceDto) {
        ...
        return converter.buildResponseEntity(Map.of("message", "Work Experience created successfully"), HttpStatus.ACCEPTED);
    }
  ...
  //need all experience for single user
    ...
    public ResponseEntity<?> getWorkExperienceById(@PathVariable Long id) {
        return converter.buildResponseEntity(Map.of("data", workExperienceService.getWorkExperienceById(id)), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> updateWorkExperienceById( @PathVariable Long id,@Valid @RequestBody WorkExperienceDto workExperienceDto) {
        return converter.buildResponseEntity(Map.of("data", workExperienceService.update(workExperienceDto,id)), HttpStatus.OK);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteWorkExperienceById(@PathVariable Long id) {
        workExperienceService.delete(id);
        return converter.buildResponseEntity(Map.of("message", "Work Experience Deleted successfully"), HttpStatus.ACCEPTED);
    }
